...
kotlinSection.innerHTML = '<div class="kotlin-heading"><div><p class="eyebrow">KOTLIN ECOSYSTEM</p><h2>Kotlin 的最新动态。</h2><p>来自 Kotlin 官方网站与 JetBrains Kotlin Blog 的更新。</p></div><a class="kotlin-brand" href="https://kotlinlang.org/" target="_blank" rel="noopener" aria-label="访问 Kotlin 官网"><span class="kotlin-logo"><svg viewBox="0 0 32 32" aria-hidden="true"><path fill="white" d="M8 7h16v5.2l-6.5 5.9 6.5 6.9H18l-5-5.3V25H8V7Zm5 5.5v5.1l5.6-5.1H13Z"/></svg></span><span>Kotlin</span><small>官方</small></a></div><div class="kotlin-news-list" id="kotlin-news-list"><article class="kotlin-news-item"><span class="news-date">LATEST</span><h3>正在读取 Kotlin 最新动态</h3><p>正在连接 Kotlin 官方信息源。</p></article></div>';
